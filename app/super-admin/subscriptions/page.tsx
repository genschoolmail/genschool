        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-500">Manage school subscriptions and billing cycles.</p>
                </div>
                <Link
                    href="/super-admin/subscriptions/plans"
                    className="flex items-center px-4 py-2 bg-slate-800 text-white rounded-lg hover:bg-slate-700"
                >
                                ...
                                <tr key={sub.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/25 transition-colors">
                                    <td className="px-6 py-4">
                                        ...
                                        <div className="text-xs text-slate-500">
                                            {sub.school.subdomain}.example.com
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
