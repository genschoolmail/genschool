            ...
            <div className="p-8">
                <div className="text-center mb-8">
                    <div
                        ...
                        className={`mx-auto mb-6 flex items-center justify-center cursor-pointer active:scale-95 transition-transform select-none relative ${school?.logo || !currentSubdomain
                    ...
                    >
                        {school?.logo ? (
                            ...
                            <img src="/images/gsm-logo.png" alt="Gen School Mail" className="w-full h-full object-contain p-2" />
                        ) : (
