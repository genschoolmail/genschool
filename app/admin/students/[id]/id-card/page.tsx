...
export default async function IDCardPage({ params }: { params: { id: string } }) {
    const [student, schoolSettings, emergencyContacts, school] = await Promise.all([
        ...
        prisma.school.findFirst({
            where: { students: { some: { id: params.id } } }
        })
    ]);
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-4 md:space-y-6 p-2 md:p-4">
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-xl md:text-2xl font-bold text-slate-800 dark:text-white">Student Profile & ID</h1>
                    <p className="text-sm md:text-base text-slate-500 dark:text-slate-400">View details and student information</p>
                </div>
            </div>

            {/* Profile Stats Cards */}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
                <div className="bg-gradient-to-br from-blue-400 to-cyan-500 p-4 md:p-6 rounded-xl shadow-lg">
                    ...
                    <p className="text-xs md:text-sm text-white/90 mt-1 font-medium">Class Identity</p>
                </div>

                <div className="bg-gradient-to-br from-green-400 to-emerald-500 p-4 md:p-6 rounded-xl shadow-lg">
                    <div className="flex items-center gap-3 mb-2">
                        <div className="p-2 md:p-3 bg-white/30 rounded-full">
                            <span className="text-2xl md:text-3xl">🏫</span>
                        </div>
                        <h3 className="font-bold text-white text-sm md:text-lg">Class</h3>
                    </div>
                ...
                <div className="bg-gradient-to-br from-purple-400 to-indigo-500 p-4 md:p-6 rounded-xl shadow-lg">
                    <div className="flex items-center gap-3 mb-2">
                        <div className="p-2 md:p-3 bg-white/30 rounded-full">
                            <span className="text-2xl md:text-3xl">👤</span>
                        </div>
                        <h3 className="font-bold text-white text-sm md:text-lg">Status</h3>
                    </div>
                    <p className="text-2xl md:text-4xl font-black text-white drop-shadow-lg uppercase">ACTIVE</p>
                    <p className="text-xs md:text-sm text-white/90 mt-1 font-medium">Student Status</p>
                </div>
            </div>
            ...
            <div className="flex justify-center mt-8 pb-12">
                <div
                    id="id-card"
                    className="bg-white overflow-hidden w-[320px] h-[480px] relative flex flex-col font-sans shadow-2xl border border-black"
                    style={{
                    ...
                    <div className="relative -mt-16 flex justify-center z-30">
                        <div className="w-28 h-28 rounded-full border-4 border-white shadow-lg overflow-hidden bg-slate-100 flex-shrink-0">
                            {student.user.image ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center bg-indigo-50 text-indigo-200 font-bold text-5xl">
