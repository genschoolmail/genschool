...
import { updateFeeSettings } from '@/lib/fee-configuration-actions';
...
export default function FeeSettingsForm({ settings }: { settings: FeeSettings }) {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        const result = await updateFeeSettings(formData);
    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6">
            <h2 className="text-lg font-bold text-slate-800 dark:text-white mb-4">Fee Settings</h2>
                    ...
                    <div className="p-4 border border-slate-200 dark:border-slate-700 rounded-xl space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                    ...
                                    name="lateFeeEnabled"
                                    value="true"
                                    defaultChecked={settings.lateFeeEnabled}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                step="0.01"
                                min="0"
                                defaultValue={settings.lateFeePercentage}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                min="0"
                                defaultValue={settings.lateFeeGraceDays}
                                className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-800 dark:text-white"
                            />
                        </div>
                    </div>
                    ...
                    <div className="p-4 border border-slate-200 dark:border-slate-700 rounded-xl space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                min="0"
                                max="100"
                                defaultValue={settings.earlyBirdDiscountPercentage}
                                className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-800 dark:text-white"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                min="0"
                                defaultValue={settings.earlyBirdDiscountDays}
                                className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-800 dark:text-white"
                            />
                        </div>
                    </div>
