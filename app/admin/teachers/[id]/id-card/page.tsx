...
export default async function TeacherIDCardPage({ params }: { params: { id: string } }) {
    const [teacher, schoolSettings, school, emergencyContacts] = await Promise.all([
        ...
        prisma.school.findFirst({
            where: { teachers: { some: { id: params.id } } }
        }),
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-4 md:space-y-6 p-2 md:p-4">
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-xl md:text-2xl font-bold text-slate-800 dark:text-white">Staff Profile & ID</h1>
                    <p className="text-sm md:text-base text-slate-500 dark:text-slate-400">View details and staff information</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
                <div className="bg-gradient-to-br from-blue-400 to-cyan-500 p-4 md:p-6 rounded-xl shadow-lg hover:scale-105 transition-all">
                    ...
                    <p className="text-xs md:text-sm text-white/90 mt-1 font-medium">Staff Number</p>
                </div>
            ...
            {/* Original Printable Faculty Card - Canva-inspired Design */}
                ...
                >
                    ...
                    <div className="relative -mt-16 flex justify-center z-30">
                        <div className="w-28 h-28 rounded-full border-4 border-white shadow-lg overflow-hidden bg-slate-100 flex-shrink-0">
                            {teacher.user.image ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center bg-purple-50 text-purple-200 font-bold text-4xl">
                    ...
                    <div className="text-center pt-3 pb-2 px-4 flex-shrink-0">
                        ...
                        <p className="text-purple-600 font-bold text-[10px] uppercase tracking-widest mt-0.5">
                            {teacher.designation || 'FACULTY STAFF'}
                        </p>
                    </div>
